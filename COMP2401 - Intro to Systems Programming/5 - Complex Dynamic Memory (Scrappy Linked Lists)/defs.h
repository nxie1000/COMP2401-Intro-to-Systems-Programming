...
#define CASH_QUOTA    1000
#define NUM_SEARCHES  5
#define DIFFICULTY    10
#define MAX_SCRAPS    100
#define MAX_STR       32
#define NUM_HUNTERS   4  // To simplify the assignment, we will assume we have exactly this many hunters every run
#define NUM_ROOMS     10 // To simplify the assignment, we will assume we have exactly this many rooms every run
